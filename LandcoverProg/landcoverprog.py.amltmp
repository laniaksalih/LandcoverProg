...
class LandcoverProg():
    ...
    def get_data_share(self, ws, datastore_name):
        """Gets the datashare 
    ...
    def start_mount(self, datastore, path):
    ...
    ***************************************************************************************/
    ...
    def load_model_files_json(self, model_name):
        ...
        """
        models = json.load(open("model_files.json", "r"))
        
        for model in models:
            if model == model_name:
                underlying_model_file_path = models[model]["underlying_model_file_path"]
                augment_model_file_path = models[model]["augment_model_file_path"]
                augment_x_train_file_path = models[model]["augment_x_train_file_path"]
                augment_y_train_file_path = models[model]["augment_y_train_file_path"]
                break
    ...
    ***************************************************************************************/
    """
        ...
        test = KerasDenseFineTune(underlying_model_file_path, augment_model_file_path, augment_x_train_file_path,augment_y_train_file_path)
    ...
    def load_classes_json(self):
        ...
        for i in range(len(classes)):
            class_list.append(classes[i]['name'])
    ...
    def load_colors_json(self):
        ...
        """
        colors = json.load(open("classes.json", "r"))
        color_list = []
    
        for i in range(len(colors)):
            color_list.append(colors[i]['color'])
    ...
    ***************************************************************************************/
    ...
    def move_file_to_fileshare(self, file_path):
        ...
        share_name = "landcover-ai/classified_images"
